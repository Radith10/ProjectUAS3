        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 fh5co-heading animate-box">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <p>Pesan Ayam Geprek Anda sekarang dan nikmati layanan pesan antar yang cepat dan aman. 
                                Kami memastikan makanan Anda tiba dalam keadaan segar dan siap dinikmati.

                                Apakah ini sesuai dengan yang kamu cari?</p>
                        </div>
                    </div>
                </div>

                <div class="col-md-5 animate-box img-to-responsive animate-box" data-animate-effect="fadeInLeft">
                    <img src="/assets/images/ayam1.jpg" alt="Logo Perusahaan"  >
                </div>
                <div class="col-md-7 animate-box" data-animate-effect="fadeInRight">
                    <blockquote>
                        <p> &ldquo;Nikmati sensasi pedas Ayam Geprek terbaik kami, disajikan dengan 
                            bumbu rempah pilihan dan sambal segar. Setiap gigitan akan memberikan 
                            pengalaman rasa yang menggoda. &rdquo;</p>
                        <p class="author"><cite>&mdash; Geprek Jogja</cite></p>
                    </blockquote>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-6 animate-box">
                    <div class="fh5co-heading">
                        <h2> Porsi besar dengan harga yang terjangkau</h2>
                        <p>Ayam Geprek Jogja kami dibuat dengan resep autentik, menggabungkan ayam goreng krispi dan sambal uleg segar. 
                            Bumbu khas Jogja yang kaya rempah menambah kenikmatan di setiap gigitannya</p>
                    </div>
                </div>
                                        ...
                                        <div class="row">
                                            <div
                                                ...
                                                <div class="slider-text-inner">
                                                    <div class="desc">
                                                        <p>Rasakan kelezatan Ayam Geprek Jogja yang terkenal dengan sambal khasnya yang pedas dan nikmat. 
                                                            Setiap suapan membawa kehangatan cita rasa tradisional Jogja yang tak tertandingi.
                                                        </p>
